/* FarmVista — <fv-shell> v5.9.4 (project-site friendly)
   - All paths are BASE-RELATIVE to support <base href="/Farm-vista/">
   - Works at https://dkillam05.github.io/Farm-vista/
*/
(function () {
  ...
  <aside class="drawer" part="drawer" aria-label="Main menu">
    ...
    <!-- Menu populated from js/menu.js -->
  ...
  class FVShell extends HTMLElement {
    ...
    _renderMenu(cfg){
      ...
      const mkLink = (item, depth=0) => {
        ...
        if ((mode==='exact' && location.pathname === new URL(a.href, location.href).pathname)
         || (mode!=='exact' && item.href && path.startsWith(a.href))) {
