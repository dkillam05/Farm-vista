(function(){
  ...
  function initShell(){
    ...
    root.innerHTML = [
      '<div class="fv-shell">',
        '<aside class="fv-sidebar sidebar" aria-label="Primary" aria-hidden="true">',
          '<div class="s-head">',
        ...
        '<header class="fv-header site-header site-header--with-bc">',
          '<div class="fv-header-inner">',
            '<button id="menuButton" class="hamburger-btn" type="button" aria-label="Toggle menu" data-hamburger onclick="toggleSidebar()">☰</button>',
          ...
          '</div>',
        '</header>',
        '<main class="fv-main main-content" id="fvMain">',
          '<div class="container">',
            '<div id="fvOutlet"></div>',
          '</div>',
        '</main>',
